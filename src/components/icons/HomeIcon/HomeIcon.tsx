...
const HomeIcon: FC<IIconsProps> = ({ color = '#1E2123', width = 12, height = 12 }) => {
  return (
    <svg
      width={width}
      height={height}
