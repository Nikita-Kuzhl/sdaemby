    ...
    <section className={styles.container}>
      <div className={styles.card}>
        ...
        <main className={styles.main}>
          ...
          <span>бесплатно создавать и публиковать</span> объявления на сайте.
        </main>
        <footer className={styles.footer}>
          <button className={styles.footer__button}>+ Разместить объявление</button>
        </footer>
      </div>
      <div className={styles.card}>
        <header className={styles.header}>
        ...
        <footer className={styles.footer}>
          <button className={styles.footer__button}>
            Узнать стоимость услуги <RightArrowIcon color='rgba(36, 36, 36, 1)' />
          </button>
        </footer>
      </div>
      <div className={styles.card}>
        ...
        <main className={styles.main}>
          Приоритетное размещение <span>Gold</span> позволяет <span>закрепить ваше объявление</span>{' '}
          в верхней части каталога!
          <p>
            Gold объявления <span>перемещаются каждые 5 мин</span> на 1 позицию, что делает
            размещение одинаковым для всех.
          </p>
          <img src='/assets/images/stars.svg' alt='start' className={styles.stars} />
        </main>
        <footer className={styles.footer}>
        ...
        <img src='/assets/images/card_bg.svg' alt='card_bg' className={styles.card_bg} />
      </div>
    </section>
  )
}
