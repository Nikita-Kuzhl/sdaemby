  ...
  return (
    <header className={styles.header}>
      ...
      <div className={styles.container}>
        <p className={styles.date}>{date.toLowerCase().substring(0, date.length - 2)}</p>
        <div className={styles.social}>
          ...
          <ul className={styles.list}>
            ...
            <a className={styles.icon__block} href='https://ru-ru.facebook.com/vibe'>
              <FacebookIcon style={styles.icon} />
            </a>
            <a className={styles.icon__block} href='https://www.viber.com/ru/'>
              <ViberIcon style={styles.icon} width={16.5} height={17.4} />
            </a>
            <a className={styles.icon__block} href='https://web.telegram.org/z/'>
              <TelegramIcon style={styles.icon} />
            </a>
            <a className={styles.icon__block} href='https://www.whatsapp.com/?lang=ru'>
